  ...
  return (
    ...
    >
      ...
      <div className="fixed top-4 right-4 z-30 flex gap-2">
        <a
          href="https://github.com/jasonherngwang/dance-dance-devolution"
          target="_blank"
          rel="noopener noreferrer"
          className="w-9 h-9 flex items-center justify-center chrome-frame"
          style={{ color: "#00eeff", background: "#120024" }}
        ...
        <button
          className="w-9 h-9 flex items-center justify-center text-lg chrome-frame"
